...
if (isset($_GET['order_number'])) {
    ...
    mysqli_stmt_bind_param($stmt, "si", $orderNumber, $userId);
    ...
    $order['items'] = mysqli_fetch_all(mysqli_stmt_get_result($itemStmt), MYSQLI_ASSOC);
    mysqli_stmt_close($itemStmt);

    json_success(['order' => $order]);
}

// Full order list, newest first, with items nested
